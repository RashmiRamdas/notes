import './howBrowsersWork.css';


const HowBrowsersWork = () => {
  return (
    <article className="content">
      ...
      <section>
        ...
        <ul>
          <li>
            ...
            scripts) may require its own lookup.
          </li>
          <li>
          ...
          <li>
            ...
            the secure channel. This adds latency but is critical for security.
          </li>
        </ul>
      </section>
      ...
      <section>
        <h2>Parsing</h2>
        <p>
          Once the browser receives the first chunk of data, it can begin
          parsing the information received. Parsing is the step the browser
          takes to turn the data it receives over the network into the DOM and
      ...
      <section>
        ...
        <ol>
          ...
          <li>
            <strong>
              Use browser/device built-in decoders instead of custom ones.
            </strong>
            <ul>
              <li>
          ...
          <li>
            <strong>
              ...
              rendering path in startup HTML.
            </strong>
            <ul>
              <li>
      ...
      <section>
        ...
        <p>
          ...
          <br />
          These styles will only be loaded when the document is being printed
          <br />
  ...
  display: flex;
      ...
      <section>
        ...
        <p>
          ...
          <code>
            ...
            align-content, align-items, flex, box-shadow
          </code>
        </p>
        <p>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            <pre>
              <code>
                &lt;head&gt; &lt;link rel="preload" href="important-js.js"
                as="script" /&gt; &lt;/head&gt;
              </code>
            </pre>
            ...
            your page
            <pre>
              <code>&lt;script src="important-js.js"&gt;&lt;/script&gt;</code>
            </pre>
          </li>
          <li>
            ...
            attribute
            <pre>
              <code>&lt;script async src="main.js"&gt;&lt;/script&gt;</code>
            </pre>
          </li>
          <li>
      ...
      <section>
        ...
        <ul>
          <li>
            CSS is always render blocking, unless loaded with special attributes
            (media, disabled, etc.)
          </li>
        ...
        <h3>
          Why is a display:none element still in the DOM but not in the render
          tree?
        </h3>
        <ul>
          <li>
            The DOM represents the document structure and is needed for
            JavaScript, events, and accessibility, so hidden elements remain
            there.
          </li>
          <li>
            The render tree is built for layout and painting only, so it
            excludes elements that don’t affect the visual output, like
            display:none.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            The browser immediately downloads (if not already cached) and
            executes the script.
          </li>
          <li>
            Only after the script finishes executing does the browser resume
            HTML parsing.
          </li>
          <li>
            This means the script blocks the rendering of the page until it's
            executed.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            The script is downloaded in parallel with HTML parsing (doesn't
            block parsing).
          </li>
          <li>
            The script execution is deferred until after the entire HTML has
            been parsed.
          </li>
          <li>
            Deferred scripts are executed in the order they appear in the
            document before the DOMContentLoaded event fires.
          </li>
          <li>
            This leads to non-blocking behavior and often better performance.
          </li>
        </ul>
      </section>
    </article>
...
export default HowBrowsersWork;
